...
- **Best used when:** A user wants a strong stretch-mediated growth stimulus, which the extended shoulder position delivers in a way a standing curl cannot replicate. This general framing is also grounded in the broader stretch-mediated hypertrophy literature (Schoenfeld & Grgic, 2020; Wolf et al., 2023, 2025) — see the canonical YAML record's evidence_notes for citations.
...
- **Coverage:** Isolation, lengthened-position emphasis, moderate setup.
- **Best used when:** A user's triceps work is all pressing and pushdowns, and what's missing is the long head's strongest stretch-mediated growth stimulus. A barbell or EZ-bar allows the heaviest load on a fixed path; a dumbbell in each hand allows independent arms and a path that can suit individual shoulder mobility better. This general framing is also grounded in the broader stretch-mediated hypertrophy literature (Schoenfeld & Grgic, 2020; Wolf et al., 2023, 2025), on top of the exercise-specific Maeo et al. (2023) finding cited above — see the canonical YAML record's evidence_notes.
...
- The general "stretch-mediated growth stimulus" claims on Incline Dumbbell Curl and Overhead Triceps Extension now carry evidence notes citing the broader stretch-mediated hypertrophy literature (see `data/exercises/arms.yaml`), in addition to their exercise-specific citations below.
