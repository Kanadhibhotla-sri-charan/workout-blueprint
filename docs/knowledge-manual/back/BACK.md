...
- **Vertical pulling:** pulling from overhead toward the torso; the main lat-dominant family.
- **Horizontal pulling:** rowing patterns that also load the mid-back, rhomboids, and mid/lower trapezius.
...
- **Why this exists:** A bodyweight vertical pull that requires little equipment and scales through added load, tempo, or assistance.
- **Primary targets:** Lats; elbow flexors, mid-back, and trunk musculature contribute.
- **Movement:** Vertical pull.
- **Coverage:** Heavy compound, low setup, skill and relative-strength demand.
- **Best used when:** A user has a bar, wants a strong vertical pull, and can perform or scale enough repetitions to be useful.
...
- **Overlaps:** Lat pulldown and other vertical pulls.
- **Status:** Draft.

### Lat Pulldown

- **Why this exists:** A vertical pull with adjustable load, which makes it easier to control repetition ranges and progression than bodyweight pulling.
- **Primary targets:** Lats; elbow flexors and mid-back contribute.
- **Movement:** Vertical pull.
...
- **Less suitable when:** No cable stack is available, or the user specifically wants the bodyweight pattern.
- **Complements:** A rowing pattern, and lat-focused single-joint work where elbow flexors limit the pull.
- **Overlaps:** Pull-ups and other vertical pulls.
- **Status:** Draft.
...
- **Best used when:** Trunk fatigue, lower-back tolerance, or close-to-failure work is the priority.
...
- **Best used when:** A user wants per-side work, has limited equipment, or wants a row without loading both sides of the spine at once.
