...
| [3](PHASE-3-mvp.md) | Blueprint MVP application (`app/`) — Knowledge Explorer, Exercise Detail, Search/Filters, Decision Maker, built incrementally as 3A–3I | In progress (3A complete) |
